          ...
          <template>
              ...
              <div class="vx-row" style="display=flex;justify-content:center;">
                <vs-select>
                  <vs-select-item
                    ...
                    :value="embarque.id"
                    :text="embarque.nome"
                    v-for="(embarque, index) in getEmbarquesItem(indexItem)"
                  />
                </vs-select>
              </div>
            </div>
            <div class="vx-col mx-1 w-1/6" style="justify-content:center;margin:auto">
              ...
              <div class="vx-row text-center justify-center">
                ...
                >{{getCoinFormat(getAmountValueBuy(item.cor.precoCusto,getAmountQuantities(item.cor.tamanhos)))}}</span>
              </div>
            </div>
            <div class="vx-col mx-1" style="justify-content:center;margin:auto">
...
export default {
  ...
  methods: {
    ...
    getEmbarquesItem(index) {
      EmbarqueDB.getEmbarquesProduto(this.carrinho[index]).then(embarques => {
        return embarques;
      });
    },
    ...
    calcularPrecoProduto(produto) {
      ...
      const preco = _.round(
        precoProduto + (percentual / 100) * precoProduto,
        2
      );
