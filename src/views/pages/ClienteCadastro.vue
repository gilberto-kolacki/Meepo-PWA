            ...
            <vx-card title="Cadastro de cliente">
                <div class="my-6">
                    ...
                    <div class="vx-row" v-if="isJuridico">
                        <div class="vx-col w-full mb-2" v-on:keyup.enter="isJuridico ? proximoCampo('dataFundacao') : proximoCampo('dataAniversario')">
                    ...
                    <div class="vx-row">
                        <div class="vx-col w-full mb-2">
                            ...
                            <vs-textarea v-model="clienteEdit.referenciaComercial" id="referenciaComercial" name="referenciaComercial"/>
                        </div>
                    </div>
                    <div class="vx-row">
                        <div class="vx-col w-full mb-2">
